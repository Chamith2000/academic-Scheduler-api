...
const StudentDashboard = () => {
    ...
    const NavItems = [
        { icon: HiHome, label: "Dashboard", path: "/student-dashboard", bgGradient: "from-indigo-600 to-blue-600", tooltip: "View your dashboard" },
        { icon: HiCalendar, label: "Timetable", path: "/student-timetable", bgGradient: "from-indigo-600 to-blue-600", tooltip: "Check your class schedule" },
        // Note: /student-courses route is not defined in App.jsx; keep in sidebar but comment out in quick actions
        { icon: HiAcademicCap, label: "My Courses", path: "/student-courses", bgGradient: "from-indigo-600 to-blue-600", tooltip: "View your enrolled courses" },
                        ...
                        <section className="mb-8">
                            ...
                            >
                                <h1 className="text-3xl font-bold">
                                    ...
                                    {/* Sinhala: ආයුබෝවන්, {userData?.user || "සිසු"}! */}
                                </h1>
